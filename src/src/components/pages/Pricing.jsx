            ...
            >
              ...
              <CardHeader className="text-center pb-4 flex-shrink-0">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm h-10 flex items-center justify-center">{service.description}</p>
                </div>
                <div className="pt-3">
        ...
        <div className="text-center mt-12 space-y-4">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-xl mb-6">
              Why Choose <span className="bg-gradient-accent bg-clip-text text-transparent">ReelWorks</span>?
            </h3>
