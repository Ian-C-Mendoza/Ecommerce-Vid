...
export function Testimonials() {
  ...
  useEffect(() => {
    ...
    const adminTestimonials = savedTestimonials ? JSON.parse(savedTestimonials) : [];
        ...
        <div className="text-center mt-12">
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 items-center opacity-60">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold bg-gradient-primary bg-clip-text text-transparent">5000+</div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold bg-gradient-primary bg-clip-text text-transparent">24h</div>
