              ...
              <div className="grid grid-cols-3 gap-4">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="relative aspect-video rounded-lg overflow-hidden group cursor-pointer">
                    <ImageWithFallback
                      src={`https://images.unsplash.com/photo-${1625961332635 + i}?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=300`}
                      alt={`Sample ${i}`}
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-6">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-muted-foreground">Delivery: {service.duration}</span>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {addons.slice(0, 6).map((addon) => (
                    <div key={addon.name} className="flex items-center justify-between p-3 rounded-lg border border-white/10 hover:bg-surface-elevated transition-colors">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  {selectedAddons.map((addonName) => {
                    const addon = addons.find(a => a.name === addonName);
                    return (
                      <div key={addonName} className="flex items-center justify-between text-sm">
            ...
            <div className="text-center p-6 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800">
              ...
              <p className="text-sm text-green-600 dark:text-green-400">
                We'll revise your video until you're completely happy with the result.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Our professionals work their magic on your content'
              },
              {
                step: '3',
                title: 'Review & Refine',
