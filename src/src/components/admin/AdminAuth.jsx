...
import { Eye, EyeOff, Shield, Users, TrendingUp, BarChart3 } from 'lucide-react';
...
export function AdminAuth({ onLogin }) {
  ...
  const handleLogin = (e) => {
    ...
    // Demo credentials
    if (loginData.email === 'admin@reelworks.pro' && loginData.password === 'admin123') {
      toast.success('Login successful! Welcome back.');
      onLogin({
        name: 'Admin User',
        email: 'admin@reelworks.pro',
        role: 'admin'
      });
    } else {
      toast.error('Invalid credentials. Use admin@reelworks.pro / admin123');
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 dark:from-gray-900 dark:via-purple-900 dark:to-gray-900" />
      ...
      <div className="absolute bottom-20 right-20 w-32 h-32 bg-gradient-secondary rounded-full opacity-15 floating" style={{ animationDelay: '2s' }} />
      <div className="absolute top-1/2 left-10 w-16 h-16 bg-gradient-accent rounded-full opacity-25 floating" style={{ animationDelay: '4s' }} />
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 px-4">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Access powerful tools to track orders, manage services, view analytics, 
                and grow your creative business—all in one modern dashboard.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl overflow-hidden glass p-6">
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-muted-foreground">
                "This platform transformed how we manage our video editing projects. 
                The analytics and client management features are game-changers."
              </p>
              <p className="text-sm font-medium mt-2">- Sarah Chen, Creative Director</p>
            </div>
          </div>
        </div>
                ...
                <TabsContent value="login">
                  <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    <div className="text-center">
                      <p className="text-sm text-muted-foreground">
                        Demo credentials: admin@reelworks.pro / admin123
                      </p>
                    </div>
                  </form>
                </TabsContent>
